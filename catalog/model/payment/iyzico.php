<?php
class ModelPaymentIyzico extends Model {
    ...
    public function getMethod($address, $total)
    {
        ...
        if ($status) {
            $method_data = array(
                'code'       => "iyzico",
                'title' => $this->language->get('iyzico_title'). " " .$this->language->get('iyzico_img_title'),
                'terms'      => '',
                'sort_order' => $this->config->get('iyzico_form_sort_order')
            );
        }
    ...
    public function createFormInitializeRequest($json,$authorization_data) {
        ...
        $url = $this->config->get('iyzico_api_url');
    ...
    public function addCustomerMessageToOrderHistory($order_id, $order_status_id, $comment, $notify = true)
    {
